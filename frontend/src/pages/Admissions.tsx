      ...
      <section className="bg-school-blue py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-school-red-light text-sm font-medium tracking-widest uppercase">Admissions</span>
          </div>
      ...
      <section className="py-20 bg-school-cream">
        <div className="container mx-auto px-6">
                ...
                <CardContent className="p-7">
                  <div className="flex items-start justify-between mb-5">
                    <div className="w-12 h-12 rounded-full bg-school-blue/10 flex items-center justify-center">
                      <step.icon className="w-6 h-6 text-school-blue" />
                    </div>
                    <span className="font-serif text-4xl font-bold text-school-red/30 leading-none">
                      {step.number}
                    </span>
                  </div>
                  <h3 className="font-serif text-lg font-bold text-school-blue mb-3">{step.title}</h3>
          ...
          <div className="text-center">
            <Button
              size="lg"
              className="bg-school-red text-white hover:bg-school-red-light font-bold px-10 rounded-sm"
              onClick={() => {
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto">
            ...
            <Card className="border-0 shadow-card overflow-hidden">
              <div className="h-2 bg-school-blue" />
              <CardContent className="p-8">
                <ul className="space-y-4">
                  {requirements.map((req) => (
                    <li key={req} className="flex items-center gap-3">
                      <CheckCircle className="w-5 h-5 text-school-red flex-shrink-0" />
